...
const Login = () => {
    ...
    const loginWithUsernameAndPassword = async (e) => {
        ...
        try {
            const response = await axios.get(`https://localhost:7088/api/Accounts/Login?email=${email}&pass=${password}`);
    ...
    return (
        <div className="loginN">
            ...
            <div className="row justify-content-center">
                <form className="col-md-7 mt-3 pt-3 pb-3" onSubmit={loginWithUsernameAndPassword} style={{width: "auto", height: "auto"}}>
                    <div className="form-floating mb-3">
                        <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="name@example.com" value={email} onChange={(e) => setEmail(e.target.value)} />
                    ...
                    <div className="mt-3" style={{textAlign: "right"}}>
                        <span><Link to="/EmailVerify" className="forgot">Forgot your password?</Link></span>
                    </div>
                    ...
                    <div className="mt-3 text-center">
                        <span>Sign up for an account? <Link to="/Register">Sign up</Link></span>
                    </div>
                </form>
            </div>
        </div>
