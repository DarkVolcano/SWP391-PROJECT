  ...
  return (
    <div className="body-staff">
      ...
      <div className="choose-staff">
        LỰA CHỌN PHƯƠNG THỨC TÌM KIẾM SÂN QUA CÁC TÙY CHỌN DƯỚI ĐÂY.
      </div>
      <form className="check-input">
        ...
        <div className="form-floating mb-3">
          <input
            ...
            className="form-control"
            id="inputBookingid"
            placeholder="Choose booking id"
          ></input>
          <label htmlFor="inputBookingid" className="form-label">
            Booking id
          </label>
        </div>
        <div className="form-floating mb-3">
        ...
        <button>
          <Link to="/BookInStaff">Search</Link>
        </button>
      </form>
    </div>
  );
