  ...
  return (
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="User" element={<><Sidebar /><Users /></>} />
        <Route path="Role" element={<><Sidebar /><Role /></>} />
        <Route path="Court" element={<><Sidebar /><Court /></>} />
        <Route path="Home" element={<><Header /><Home /><Footer /></>} />
        <Route path="AboutUS" element={<><Header /><About /><Footer /></>} />
        <Route path="Payment" element={<><Header /><Payment /><Footer /></>} />
        <Route path="ComPay" element={<><Header /><ComPay /><Footer /></>} />
        <Route path="BookPlay" element={<><Header /><Book /><Footer /></>} />
        ...
        <Route path="OTPVerify" element={<OtpInputWithValidation numberOfDigits={6}/>}></Route>
