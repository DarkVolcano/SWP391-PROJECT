        ...
        <div className="body-book">
            <div className="book-fil">
                <div className="form-floating mb-3">
                    <input type="password" className="form-control" id="chooseday" placeholder="Choose date" />
                    <label htmlFor="chooseday" className="form-label">Choose day</label>
                </div>
                <div className="form-floating mb-3">
                    <input type="password" className="form-control" id="chooseplace" placeholder="Choose place" />
                    <label htmlFor="chooseplace" className="form-label">Choose place</label>
                </div>
            </div>
