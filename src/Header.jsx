    ...
    return (
        <div className="image-container">
            ...
            <ul>
                ...
                <li><NavLink to="/BookPlay">BOOK PLAY</NavLink></li>
                ...
                {user ? (
                  <div class="dropdowns">
                    ...
                    <button className="user-info dropbtn" onClick={toggleDropdown} style={{width: "max-content"}}>Hello {user.name || user.userName}<img src={user.picture}/></button>
