...
const Users = () => {
    ...
    const getData = () => {
        axios.get('https://localhost:7088/api/Accounts?pageNumber=1&pageSize=10')
            .then((result) => {
    ...
    const handleDelete = () => {
        axios.delete(`https://localhost:7088/api/Accounts/id?id=${deleteAccountId}`)
        .then((result) => {
            handleDeleteClose();
            getData();
    ...
    const handleEdit = (id) => {
        handleShow();
        axios.get(`https://localhost:7088/api/Accounts/id?id=${id}`)
        .then((result) => {
            console.log(result.data);
    ...
    return (
        ...
        <section className="home-section" style={{ padding: "0 27px" }}>
            ...
            <Table striped bordered hover style={{margin: "14px 0", border: "none"}}>
                <thead>
                    <tr>
                        ...
                        <th style={{borderTopLeftRadius: "10px", border: "none"}}>AccountName</th>
                        <th>Full Name</th>
                        <th>Phone</th>
                        <th>Email</th>
            ...
            <Modal show={showCreateModal} onHide={handleCreateClose} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
                ...
                <Modal.Body>
                    <Row>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter account name' value={accountName} onChange={(e) => setAccountName(e.target.value)} /></Col>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter full name' value={fullname} onChange={(e) => setFullname(e.target.value)} /></Col>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter phone' value={phone} onChange={(e) => setPhone(e.target.value)} /></Col>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter email' value={email} onChange={(e) => setEmail(e.target.value)} /></Col>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter role id' value={roleID} onChange={(e) => setRoleID(e.target.value)} /></Col>
                        <Col sm={12}>
            ...
            <Modal show={show} onHide={handleClose} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
                ...
                <Modal.Body>
                    <Row>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter account name' value={editAccountname} onChange={(e) => setEditAccountname(e.target.value)} /></Col>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter full name' value={editFullname} onChange={(e) => setEditFullname(e.target.value)} /></Col>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter phone' value={editPhone} onChange={(e) => setEditPhone(e.target.value)} /></Col>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter email' value={editEmail} onChange={(e) => setEditEmail(e.target.value)} /></Col>
                        <Col sm={12}><input type='text' className='form-control mb-3' placeholder='Enter role id' value={editRoleID} onChange={(e) => setEditRoleID(e.target.value)} /></Col>
                        <Col sm={12}>
